            ...
            <div class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th>
                                <h5 class="text-white">Rank</h5>
                            </th>
                            <th>
                                <h5 class="text-white">Nama</h5>
                            </th>
                            <th>
                                <h5 class="text-white">EXP</h5>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="player-info">
                                <p class="mt-2">Fadhel Naufal <i class="fas fa-trophy trophy" style="color: gold;">
                                </i></p>
                            </td>
                            <td>
                                750
                        ...
                        <tr>
                            ...
                            <td class="player-info">
                                <p class="mt-2">Fadhel Naufal <i class="fas fa-trophy trophy" style="color:silver;">
                                </i></p>
                            </td>
                            <td>
                                750
                        ...
                        <tr>
                            ...
                            <td class="player-info">
                                <p class="mt-2">Fadhel Naufal <i class="fas fa-trophy trophy" style="color: #cd7f32;">
                                </i></p>
                            </td>
                            <td>
                                750
