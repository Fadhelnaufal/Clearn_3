...
@section('content')
    <div class="container d-flex align-items-center mb-5">
        <a href="{{Route('siswa.join-quiz')}}" class="btn "><i class='bx bx-left-arrow-alt fs-2'></i></a>
        ...
        <div class="card">
            <div class="row">
                ...
                <div class="col-md d-flex align-items-center">
                    <div>
                        <h3 class="mb-4">Nama Quiz</h3>
                        <p class="fs-5">
                            Kerjakan quiz <strong>nama quiz</strong> dengan baik dan teliti. <br>
                        </p>
                            <a class="btn btn-primary" href="{{Route('siswa.study-quiz')}}">Kerjakan Soal</a>
                    </div>
                </div>
            </div>
        </div>
