            ...
            <div class="modal-content">
                ...
                <div class="modal-body mx-3 mt-2">
                    <p class="text-justify">
                        Sebelum Memasuki Dashboard,anda harus mengisi quesioner dibawah ini untuk mengetahui tujuan belajar anda.
                    </p>
                    <form id="questions-form" action="{{ route('store.answers') }}" method="POST">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="number-cell">{{ $question->id }}</td>
                                <td class="question-cell">{{ $question->text }}</td>
                                @for ($i = 1; $i <= 5; $i++) <td class="options-cell">
                                    <input type="radio" name="answers[{{ $index }}][answer_value]" value="{{ $i }}" required>
                                    </td>
                                    @endfor
                            </tr>
                            @endforeach
